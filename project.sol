...
contract KnowledgeIncentives {
    ...
    function getAllContributions() public view returns (Submission[] memory) {
    ...
    // Modified getAllContributions with pagination
    // function getAllContributions(uint256 page) public view returns (Contribution[] memory, uint256)
    function getAllContributions(uint256 page) 
        public 
        view 
        returns (
